...
N_geom = [[[135.0,0.0*np.pi],[102.0,0.1*np.pi],'line', 0.08],[[102.0,0.1*np.pi],[140.0,0.15*np.pi],'line', 0.08],
...
p1 = obj_planet(np.array([-60.0, 100.0]), np.array([0.0,0.0]), 150.0, geom, [p1_obj1, p1_obj2, p1_obj3, p1_obj4, p1_obj5, p1_obj6])
p1.grav_flag = 0
